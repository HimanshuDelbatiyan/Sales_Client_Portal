...
<?php
    ...
    if(!isset($_SESSION['siggned']) || $_SESSION['siggned'] != true || !isset($_SESSION['userType']) || !isset($_SESSION['emailSent']) ||
    $_SESSION['emailSent'] != "Yes")
    {
        // Then redirect the user to the sign-in page !
        header("location: sign-in.php");
        exit; // Make sure none of the code is executed after  !
    }
    else
    {
       ob_flush();
...
<html>
  <head>
    ...
    <link rel="icon" href="./racconCompany.png">
    <style type="text/css">
                        ...
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                              <tbody>
                                <tr>
                                  <!-- Image  -->
                                  <!-- <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    <img class="w-24" src="./racconCompany.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 96px; border-style: none; border-width: 0;" width="96"> -->
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td style="line-height: 24px; font-size: 16px; margin: 0;" align="center">
                                    ...
                                    <img class="w-24" src="./includes/image/racconCompany.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 96px; border-style: none; border-width: 0;" width="96">
                                    <h2 style="line-height: 24px; font-size: 26px; margin: 0;" align="center"">The Raccoon's</h2>
                                  </td>
                                </tr>
                                </tr>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; font-weight: normal" align="left">
                                    Hello <b><?php echo $_SESSION['username'];?></b>,
                                    <br>
                                    We received a request to reset your password. If you did not make this request, you can ignore this email. No changes will be made to your account.
                                    <br>
                                    ...
                                    <table class="btn btn-primary p-3 fw-700" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important;">
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 18px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#0d6efd">
                                            <a href="./resetPass.php"  style = "font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 4px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 4px; border: 1px solid #0d6efd;"> Reset Password</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="btn btn-primary p-3 fw-700" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important;">
                                      <tbody>
                                        <br><br>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 18px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#ff0000">
                                            <a href="./dashboard.php"  style = "font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 4px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 4px; border: 1px solid #0d6efd;">Nah Bro I am Good</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    ...
                                    <br>
                                            ...
                                            <br>
                                            <b>
                                            The Raccoon's. 00 Random Drive<br>
                                                Whitby ON, L1R 2H7 CA.
                                            </b>
                                    </p>
                                  </td>
                                </tr>
                            ...
                            <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                  <!-- image -->
                                    <img class="w-40" src="./includes/image/racconCompany.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 160px; border-style: none; border-width: 0;" width="160">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <div class="text-muted text-center" style="color: #718096;" align="center">
                              Sent with Love from The Raccoon's. <br>
                              The Raccoon's. 00 Random Drive<br>
                              Whitby ON, L1R 2H7 CA. <br>
                            </div>
                            <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                              <tbody>
                                <tr>
